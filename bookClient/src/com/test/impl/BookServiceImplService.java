 ...
 * 
 */
@WebServiceClient(name = "BookServiceImplService", targetNamespace = "http://impl.test.com/", wsdlLocation = "http://localhost:8888/ws/book?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKSERVICEIMPLSERVICE_QNAME = new QName("http://impl.test.com/", "BookServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/ws/book?wsdl");
    ...
    public BookService getBookServiceImplPort() {
        return super.getPort(new QName("http://impl.test.com/", "BookServiceImplPort"), BookService.class);
    }
    ...
    public BookService getBookServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.test.com/", "BookServiceImplPort"), BookService.class, features);
    }
